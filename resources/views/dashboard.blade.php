                    ...
                    <div class="col-lg-8 col-xl-7 col-xxl-6">
                        <div class="my-5 text-center text-xl-start">
                            ...
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                <a class="btn btn-primary btn-lg px-4 me-sm-3" href="#features">Lebih Lanjut</a>
                                <a class="btn btn-outline-light btn-lg px-4" href="#stores">Mitra</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container px-5 my-5">
                <div class="row gx-5">
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <h2 class="fw-bolder mb-0">Sebuah langkah awal membangun usaha.</h2>
                    </div>
                    <div class="col-lg-8">
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            <img class="card-img-top" src="{{ asset('assets/img/store-banner-1.jpg') }}"
                                alt="" />
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            <img class="card-img-top" src="{{ asset('assets/img/store-banner-2.jpg') }}"
                                alt="" />
                            <div class="card-body p-4">
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            <img class="card-img-top" src="{{ asset('assets/img/store-banner-3.jpg') }}"
                                alt="" />
                            <div class="card-body p-4">
                                <div class="badge bg-primary bg-gradient rounded-pill mb-2">News</div>
                                <a class="text-decoration-none link-dark stretched-link" href="#!">
